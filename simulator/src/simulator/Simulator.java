...
import java.util.*;
import static simulator.Simulator.addHold1;
import static simulator.Simulator.addHold2;
    ...
    public static void addHold2(Process p){
        ...
        //print process table       
            ...
            for (int i = 0; i < processCounter; i++) {
                output.printf("%5s %10s %15s %15s %n", processTable[i].getJobNumber(), processTable[i].getArrivalTime(), processTable[i].getFinishTime(), processTable[i].getTurnAroundTime());
          
            sumOfTurnAroundTime+=processTable[i].getTurnAroundTime();
            }
            float av=sumOfTurnAroundTime / processCounter;
